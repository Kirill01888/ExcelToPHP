...
class Converter
{
    ...
    public function makeTemplate()
    {
        ...
        if ($c == 'linear' or $c == 'path') {
            ...
            $myHash .= substr($c, 0, 3);
            $c = self::$fileReader->getStyle('B1')->getFill()->getRotation();
            $baseTemplate["fill"] = str_replace('<R>', $c, $baseTemplate["fill"]);
            $c = self::$fileReader->getStyle('B1')->getFill()->getStartColor()->getARGB();
            $baseTemplate["fill"] = str_replace('<COLS>', $c, $baseTemplate["fill"]);
            $c = self::$fileReader->getStyle('B1')->getFill()->getEndColor()->getARGB();
        ...
        //borders
        $c = self::$fileReader->getStyle('B1')->getBorders()->getLeft()->getBorderStyle();
        if ($c != 'none') {
            $myHash .= substr($c, 0, 3);
        ...
        $c = self::$fileReader->getStyle('B1')->getBorders()->getRight()->getBorderStyle();
        if ($c != 'none') {
            $myHash .= substr($c, 0, 3);
        ...
        $c = self::$fileReader->getStyle('B1')->getBorders()->getTop()->getBorderStyle();
        if ($c != 'none') {
            $myHash .= substr($c, 0, 3);
            $baseTemplate['borders'] = $this->bord['top'];
            $baseTemplate['borders']['top'] = str_replace('<BRD>', $this->arrBorders[$c], $baseTemplate['borders']['top']);
        }
        $c = self::$fileReader->getStyle('B1')->getBorders()->getBottom()->getBorderStyle();
        if ($c != 'none') {
            $myHash .= substr($c, 0, 3);
        ...
        $c = self::$fileReader->getStyle('B1')->getBorders()->getDiagonal()->getBorderStyle();
        if ($c != 'none') {
            $myHash .= substr($c, 0, 3);
